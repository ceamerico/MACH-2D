...
module mod_mach2d_data
   ...
   integer :: modturb !< Turbulence model (0=Laminar, 1=Baldwin Lomax)
...
contains
   ...
   subroutine get_parameters
      ...
      call ifile%get_value(   modturb,   "modturb") ! Turbulence model (0=Laminar, 1=Baldwin Lomax)
  ...
  100 format( "'", A21, "'",' ....: ',A)
      ...
      write(fid,"(I23,' ....: ',A)")    modturb , " modturb - Turbulence model (0=Laminar, 1=Baldwin Lomax)"
      write(fid,*)
   ...
   subroutine allocate_variables
      ...
      ,          Ta(nxy),       bt(nxy),       pa(nxy),         g(nxy),          vtp(nxy) &
      ,         rona(nxy),      ro_av(nxy),    ron_av(nxy),     u_av(nxy),       v_av(nxy)     )
